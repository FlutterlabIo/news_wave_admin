...
import 'package:news_wave_admin/features/live_streaming/providers/live_stream_provider.dart';
...
class _LiveStreamViewState extends State<LiveStreamView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<LiveStreamProvider>(builder: (context,value,child)=>SafeArea(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FormTextField(
                                  hintText: 'meta key', controller: value.metaKeyController),
                              SizedBox(
                                height: 10,
                              ),
                              Text('schema mark up *'),
                              ...
                              FormTextField(
                                  hintText: 'schema mark up', controller: value.schemaMarkUpController),
                              SizedBox(
                                height: 10,
                              ),
                              ...
                              FormTextField(
                                  hintText: 'Meta title', controller: value.metaTitleController),
                              ...
                              FormTextField(
                                  hintText: 'Meta des', controller: value.metaDesController),
                                  ...
                                  rows: newsData.map((data) {
                                    return DataRow(
                                      cells: <DataCell>[
                                        ...
                                        DataCell(Text(data['metaKey'].toString())),
                                        DataCell(Text(data['schemaMarkUp'].toString())),
                                        DataCell(Text(data['metaTitle'].toString())),
                                        DataCell(Text(data['metaDes'].toString())),
