                            ...
                            rows: tableData.map((data) {
                              return DataRow(
                                cells: <DataCell>[
                                  ...
                                  DataCell(Text(data['news type'].toString())),
                                  DataCell(Text(data['video type'].toString())),
                                  DataCell(Text(data['filter type'].toString())),
                                  DataCell(Text(data['app style'].toString())),
                                  DataCell(Text(data['web style'].toString())),
